<template>
    <div>
        ...
        <div v-if="installed" class="mb-2">
            <div class="mb-4">
                ...
                <div class="form-text">
                    ...
                    <br />
                    <a
                        href="https://github.com/dtayme/uptime-kuma-distributed/wiki/Reverse-Proxy-with-Cloudflare-Tunnel"
                        target="_blank"
                    >
                        https://github.com/dtayme/uptime-kuma-distributed/wiki/Reverse-Proxy-with-Cloudflare-Tunnel
                    </a>
                </div>
            </div>
        ...
        <div>
            ...
            <br />
            {{ $t("Please read") }}
            <a href="https://github.com/dtayme/uptime-kuma-distributed/wiki/Reverse-Proxy" target="_blank">
                https://github.com/dtayme/uptime-kuma-distributed/wiki/Reverse-Proxy
            </a>
            .
        </div>
